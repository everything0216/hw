...
function btn1(zone){
    $(".card-group").empty();
    $.ajax({
        url: 'http://127.0.0.1:8080/SightAPI/'+zone,
        type: 'get',
                        ...
                        '<div class="col-12 col-sm-4">'+
                            '<div class="card border-dark mb-3" style="width: 21rem;">'+
                                '<div class="card-body">'+
                                    ...
                                    '<a href="https://www.google.com/maps/search/?api=1&query='+data[i].address+'" class="btn btn-link" target="_blank">'+data[i].address+'</a>'+'<br>'+
